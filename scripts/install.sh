...
curl -sL https://releases.hashicorp.com/terraform/0.14.11/terraform_0.14.11_linux_amd64.zip > terraform-0.14.11.zip    & \
wait
...
mv terraform /usr/local/bin/terraform-0.12.29

unzip terraform-0.13.7.zip
rm terraform-0.13.7.zip
mv terraform /usr/local/bin/terraform-0.13.7

unzip terraform-0.14.11.zip
rm terraform-0.14.11.zip
